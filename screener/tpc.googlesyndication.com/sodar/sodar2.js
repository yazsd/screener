...
*/
        ...
        if (b)
            a: {
                ...
                null != b && (a ? l(r, d, {
                    ...
                    writable: !0,
                    value: b
                }) : b !== c && (void 0 === u[d] && (a = 1E9 * Math.random() >>> 0,
    ...
    function ka(a, b) {
        ...
        var c = a.g.h;
        if (c)
            return F(a, "return"in c ? c["return"] : function(d) {
                return {
                    value: d,
                    done: !0
                }
    ...
    function la(a) {
        this.next = function(b) {
            C(a.g);
            a.g.h ? b = F(a, a.g.h.next, b, a.g.o) : (a.g.o(b),
            b = G(a));
            return b
        }
        ;
        this.throw = function(b) {
            C(a.g);
            a.g.h ? b = F(a, a.g.h["throw"], b, a.g.o) : (D(a.g, b),
            b = G(a));
            return b
        }
        ;
    ...
    function qa(a, b) {
        ...
        a = c.replace(sa, function(d, g) {
            if (!Object.prototype.hasOwnProperty.call(b, g))
                throw Error('Found marker, "' + g + '", in format string, "' + c + '", but no valid label mapping found in args: ' + JSON.stringify(b));
            d = b[g];
...
*/
    ...
    function Ua(a, b) {
        function c(h) {
            h && null !== h.data && "https://www.google.com" === h.origin && null != h.source && h.source === b.contentWindow && (a.i = "id=sodar2&v=225",
            a.g && (a.i += "&li=" + encodeURIComponent(a.g.F.toString()),
            a.i += "&" + ("cr" === a.g.context ? "bgai" : "jk") + "=" + encodeURIComponent(a.g.D.toString()),
            h.source.postMessage(JSON.stringify({
                id: "sodar",
                params: a.i
    ...
    function Ta(a) {
        ...
        return H(function(g) {
            if (1 == g.g)
                return b = S(M(new K(L,"https://tpc.googlesyndication.com/sodar/sodar2/225/runner.html"))),
                E(g, va(b), 2);
            if (4 != g.g) {
                c = g.i;
                if (!c.contentWindow)
